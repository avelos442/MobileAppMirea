...
import ru.mirea.laptevavs.looper.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun fromTaskCode() {
        ...
        binding.button.setOnClickListener {
            ...
            val positionText = binding.editTextJob.text.toString()
            ...
            bundle.putString("JOB", positionText)
            msg.data = bundle
    ...
    private fun fromExampleCode() {
        ...
        binding.textView.text = "Мой номер по списку 14"
        binding.button.setOnClickListener {
            val msg = Message.obtain()
            val bundle = Bundle()
